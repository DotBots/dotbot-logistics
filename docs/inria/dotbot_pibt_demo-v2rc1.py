#!/usr/bin/env python3
"""
dotbot_pibt_demo-v2rc1.py — Version DURCIE (exécution pas-à-pas synchronisée).
...
Pour la version simulateur d'origine (envoi en masse), voir dotbot_pibt_demo-v1.py.
...
Usage :
    python dotbot_pibt_demo-v2rc1.py                 # exécution pas-à-pas synchronisée
    python dotbot_pibt_demo-v2rc1.py --dry-run       # affiche les cibles sans envoyer
    python dotbot_pibt_demo-v2rc1.py --steps 40      # nombre de steps PIBT (défaut : 30)
    python dotbot_pibt_demo-v2rc1.py --threshold 120 --step-timeout 10
    python dotbot_pibt_demo-v2rc1.py --map-cells 8 --cell-mm 250  # grille 8×8 (défaut)
...
DEFAULT_THRESHOLD = 100   # mm — un bot est considéré "arrivé" à sa case quand
                          # distance < threshold. 100mm : < demi-case (125mm) pour
