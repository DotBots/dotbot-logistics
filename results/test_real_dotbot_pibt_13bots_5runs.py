#!/usr/bin/env python3
"""
test_real_dotbot_pibt_13bots_5runs.py — Batch test: 13 bots, 5 runs.

Runs PIBT step-by-step on 13 real DotBots for 5 independent trials and
...
NUM_AGENTS  = 13
NUM_RUNS    = 5
SCRIPT_NAME = "test_real_dotbot_pibt_13bots_5runs"
