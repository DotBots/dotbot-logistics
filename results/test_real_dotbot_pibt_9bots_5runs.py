#!/usr/bin/env python3
"""
test_real_dotbot_pibt_9bots_5runs.py — Batch test: 9 bots, 5 runs.

Runs PIBT step-by-step on 9 real DotBots for 5 independent trials and
...
NUM_AGENTS  = 9
NUM_RUNS    = 5
SCRIPT_NAME = "test_real_dotbot_pibt_9bots_5runs"
